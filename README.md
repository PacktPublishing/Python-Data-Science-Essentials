...
Set up your data science toolbox using a Python scientific environment <br>
Get data ready for your data science project<br>
Manipulate, fix, and explore data in order to solve data science problems<br>
Set up an experimental pipeline to test your data science hypotheses<br>
Choose the most effective and scalable learning algorithm for your data science tasks<br>
